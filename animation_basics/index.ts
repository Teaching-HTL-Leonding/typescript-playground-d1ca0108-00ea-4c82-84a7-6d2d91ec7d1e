...
function draw() {
    ...
    if (imageIndex === 0) { currentImage = necromancer1; }
    else if (imageIndex === 1) { currentImage = necromancer2; }
    else if (imageIndex === 2) { currentImage = necromancer3; }
    else if (imageIndex === 3) { currentImage = necromancer4; }
    else if (imageIndex === 4) { currentImage = necromancer5; }
    else if (imageIndex === 5) { currentImage = necromancer6; }
    else if (imageIndex === 6) { currentImage = necromancer7; }
    else if (imageIndex === 7) { currentImage = necromancer8; }
    else if (imageIndex === 8) { currentImage = necromancer9; }
    else if (imageIndex === 9) { currentImage = necromancer0; }
